...
class Embedding(nn.Module):
    def __init__(self,isize,nc,reg,device,q,C,U_init,k=100,num_random_samples=100,R=1,ndf=64,seed=49,random=False):
    ...
    def Feature_Map_Gaussian(self,X):
        ...
        res = (1/torch.sqrt(torch.DoubleTensor([self.num_random_samples]))) * res_trans
